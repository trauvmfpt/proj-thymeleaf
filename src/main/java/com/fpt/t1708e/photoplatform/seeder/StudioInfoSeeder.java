    ...
    public void addStudio(){
       ...
       // 1. 
        ...
        studioInfo.setDescription("
            ...
            Những thiết bị quay chụp ảnh cưới hiện đại nhất để phục vụ bạn.
            Trang phục, váy cưới cao cấp, phụ kiện đúng gout chuẩn trend
            Những chuyên gia makeup tuyệt đỉnh sẽ làm bạn đẹp hơn cả bạn tưởng tượng.
            Phục vụ chu đáo. Đề xuất phù hợp với bạn, lắng nghe ý tưởng của bạn. 
            Đưa đón bạn với xe sang miễn phí, chăm sóc bạn trong suốt quá trình chụp, chỉnh sửa tận tâm và trân trọng những yêu cầu của bạn để hoàn thiện bộ ảnh ước mơ của bạn. 
            Các gói dịch vụ luôn đảm bảo có lợi nhất cho khách hàng - giá cả luôn xứng đáng với chất lượng
            Đó là những thông tin tổng quát về Yêu Media mà Toplist muốn giúp bạn tìm hiểu.
            ...
            Với những đôi uyên ương đã từng sử dụng dịch vụ của Yêu Media thì chắc hẳn đều rất ấn tượng với phong cách phục vụ của tất cả ekip và sự chuyên nghiệp, vui vẻ, nhiệt tình, chu đáo trong mỗi nhân viên ở tất cả các khâu. Bởi lẽ đối với Yêu Media, sự hài lòng và niềm vui của khách hàng mới chính là thành công lớn nhất, gây dựng nên thương hiệu như ngày hôm nay và mãi là “kim chỉ nam” trong quá trình phát triển mãi sau này.
