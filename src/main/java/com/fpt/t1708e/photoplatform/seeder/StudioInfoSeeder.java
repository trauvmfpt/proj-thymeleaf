...
public class StudioInfoSeeder {
    ...
    public static void addStudio() {
        ...
        studioInfo.setEmail("trauvmd00621@fpt.edu.vn");
        ...
        studioInfo.setDescription("Ảnh viện Vivian là một trong những thương hiệu nổi tiếng trong lĩnh vực ảnh cưới, ảnh gia đình, ảnh em bé, ảnh thời trang, ảnh nghệ thuật tại Hà Nội. Và trong danh sách của Toplist ngày hôm nay, đây cũng là một cái tên không thể không nhắc đến.\n" +
        ...
        studioInfo.setDescription("Hailecao nổi tiếng với phong cách ảnh rất riêng biệt. Các bộ ảnh của Hailecao hướng tới sự bay bổng, tự nhiên, lãng mạn và hơn hết là làm nổi bật được phong cách và cá tính của từng cô dâu chú rể.\n" +
        ...
        studioInfo.setDescription("Đúng như cái tên, Phiêu Media sẽ mang đến cho các cặp đôi những bộ ảnh siêu chất. Thế mạnh của studio này là những góc chụp ở biển đảo như Nha Trang, Cô Tô, Lý Sơn… với những góc chụp đẹp đến khó tin sẽ khiến các cặp đôi khó tính nhất cũng phải hài lòng.\n" +
        ...
        studioInfo.setDescription("Nupakachi Studio là thương hiệu chụp ảnh cưới được nhiều bạn trẻ lựa chọn. Với kinh nghiệm và 6 năm được sự tin tưởng từ khách hàng, mỗi năm thực hiện hàng trăm bộ ảnh cưới trong nước, thường xuyên chụp ảnh cưới tại các quốc gia Châu Á, Châu Âu...\n" +
        ...
        studioInfo.setDescription("Phong cách chủ đạo nhất của studio này là lãng mạn, nhẹ nhàng. Bởi vậy, dù đa dạng trong cách tạo cảnh, tạo dáng theo các xu hướng teen, cổ điển hay sang trọng thì những bức hình của Aube vẫn toát lên một cảm xúc nhẹ nhàng, ngọt ngào và lãng mạn. Aube studio cung cấp nhiều gói chụp ảnh với phong phú các địa điểm từ trong nước đến các nước như Thái Lan, Malaysia, Singapore…\n" +
        ...
        studioInfo.setDescription("Tình yêu của bạn sắp đến ngày đơm hoa kết trái, hai nửa trái tim sắp hòa chung một nhịp thở vì thế bạn muốn lưu lại khoảnh khắc tuyệt vời đó để làm kỉ niệm đẹp, mỗi album ảnh cưới đẹp sẽ là một hành trang đẹp trong cuộc sống hôn nhân của bạn.\n" +
        ...
        studioInfo.setDescription("Đây cũng là một trong những studio được giới trẻ Hà thành yêu thích. Với sự chuyên nghiệp, nhiệt tình và am hiểu các giá trị thẩm mỹ, L'amant sẽ mang đến cho bạn những khung hình thật sự như ý muốn.\n" +
